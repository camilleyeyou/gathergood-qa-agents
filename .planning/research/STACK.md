...
**Domain:** Event management platform (Django + Next.js)
**Researched:** 2026-03-28
**Confidence:** HIGH (versions verified against PyPI and npm, March 2026)
...
```bash
npx create-next-app@latest gathergood-frontend \
  --typescript \
  --tailwind \
  --eslint \
  --app \
...
**For free event checkout (no payment):**
...
**For QR check-in (mobile/tablet use):**
...
---
*Stack research for: GatherGood event management platform (Django + Next.js)*
*Researched: 2026-03-28*
