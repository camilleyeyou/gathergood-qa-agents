...
Plans:
- [ ] 04-01-PLAN.md — Permission boundary tests for VOLUNTEER, MANAGER, and non-member roles (TPERM-01 to TPERM-05)
- [ ] 04-02-PLAN.md — Guest list, email settings, and analytics API tests (TGUST-01/02, TEMAL-01 to TEMAL-04, TANLT-01 to TANLT-03)
- [ ] 04-03-PLAN.md — Public browse, org page, and event detail with tier visibility filtering (TPUBL-01 to TPUBL-05)
- [ ] 04-04-PLAN.md — Playwright setup and homepage, navbar, responsive, touch target browser tests (TFEND-01/02/03/07/08/09)
...
| 4. Permissions, Analytics & Browser UI | 0/5 | Not started | - |
